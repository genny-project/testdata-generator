...
public class SpecialAttributes {
    ...
    public static final String PRI_DOC_HCRI_STATUS = "PRI_DOC_HCRI_STATUS";
    public static final String PRI_HCS_AGR_OUTCOME_SIGNATURE = "PRI_HCS_AGR_OUTCOME_SIGNATURE";
